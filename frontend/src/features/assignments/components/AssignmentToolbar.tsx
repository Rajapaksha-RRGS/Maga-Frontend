...
import { Copy, Users, History, Calendar, Check, X, ChevronRight, ChevronLeft, RefreshCw } from 'lucide-react';
      ...
      {showPastGangsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-lg overflow-hidden flex flex-col max-h-[85vh]">
            ...
            {/* Content List */}
            <div
              className="p-5 overflow-y-auto space-y-4 flex-1 scrollbar-none"
