...
const SEED_ACTIVITIES = [
  { code: 'EW-01', description: 'Excavation work' },
  { code: 'CW-01', description: 'Concrete work' },
  { code: 'CW-02', description: 'Formwork' },
  { code: 'CW-03', description: 'Rebar work' },
  { code: 'MW-01', description: 'Masonry work' },
  { code: 'PW-01', description: 'Plumbing work' },
  { code: 'EL-01', description: 'Electrical work' },
  { code: 'GW-01', description: 'General labour' },
  { code: 'PT-01', description: 'Painting work' },
  { code: 'WD-01', description: 'Welding work' },
];
...
const MOCK_ERP_ROWS: ErpUploadRow[] = [
  { id: 'erp-001', employeeId: 'emp-001', employeeName: 'Kamal Perera',       date: '2026-08-01', activityCode: 'EW-01', activityDescription: 'Excavation work', hours: 8, overtimeHours: 0,   remarks: 'Main foundation trench' },
  { id: 'erp-002', employeeId: 'emp-001', employeeName: 'Kamal Perera',       date: '2026-08-02', activityCode: 'CW-01', activityDescription: 'Concrete work',   hours: 8, overtimeHours: 2,   remarks: 'Overtime approved for pour' },
  { id: 'erp-003', employeeId: 'emp-002', employeeName: 'Nimal Silva',        date: '2026-08-01', activityCode: 'CW-02', activityDescription: 'Formwork',         hours: 8, overtimeHours: 0,   remarks: 'Column formwork assembly' },
  { id: 'erp-004', employeeId: 'emp-002', employeeName: 'Nimal Silva',        date: '2026-08-02', activityCode: 'CW-02', activityDescription: 'Formwork',         hours: 8, overtimeHours: 1.5, remarks: 'Completed beam brackets' },
  { id: 'erp-005', employeeId: 'emp-003', employeeName: 'Sunil Fernando',     date: '2026-08-01', activityCode: 'EL-01', activityDescription: 'Electrical work',  hours: 8, overtimeHours: 0,   remarks: 'Conduit laying Level 2' },
  { id: 'erp-006', employeeId: 'emp-003', employeeName: 'Sunil Fernando',     date: '2026-08-02', activityCode: 'EL-01', activityDescription: 'Electrical work',  hours: 6, overtimeHours: 0,   remarks: 'Left early for site medical check' },
  { id: 'erp-007', employeeId: 'emp-004', employeeName: 'Chaminda Rajapakse', date: '2026-08-01', activityCode: 'GW-01', activityDescription: 'General labour',   hours: 8, overtimeHours: 0,   remarks: 'Site clearing' },
  { id: 'erp-008', employeeId: 'emp-004', employeeName: 'Chaminda Rajapakse', date: '2026-08-02', activityCode: 'GW-01', activityDescription: 'General labour',   hours: 8, overtimeHours: 0,   remarks: 'Material transfer' },
  { id: 'erp-009', employeeId: 'emp-005', employeeName: 'Ruwan Jayawardena',  date: '2026-08-01', activityCode: 'PW-01', activityDescription: 'Plumbing work',    hours: 8, overtimeHours: 1,   remarks: 'Pressure testing pipe grid' },
  { id: 'erp-010', employeeId: 'emp-006', employeeName: 'Pradeep Bandara',    date: '2026-08-01', activityCode: 'WD-01', activityDescription: 'Welding work',     hours: 8, overtimeHours: 0,   remarks: 'Steel truss joints' },
  { id: 'erp-011', employeeId: 'emp-006', employeeName: 'Pradeep Bandara',    date: '2026-08-02', activityCode: 'WD-01', activityDescription: 'Welding work',     hours: 8, overtimeHours: 2,   remarks: 'Night shift structural reinforcement' },
  { id: 'erp-012', employeeId: 'emp-007', employeeName: 'Lakmal Dissanayake', date: '2026-08-01', activityCode: 'MW-01', activityDescription: 'Masonry work',     hours: 8, overtimeHours: 0,   remarks: 'Partition walling Block B' },
  { id: 'erp-013', employeeId: 'emp-008', employeeName: 'Asanka Kumara',      date: '2026-08-01', activityCode: 'CW-03', activityDescription: 'Rebar work',       hours: 7, overtimeHours: 0,   remarks: 'Cut and bend station' },
  { id: 'erp-014', employeeId: 'emp-008', employeeName: 'Asanka Kumara',      date: '2026-08-02', activityCode: 'CW-03', activityDescription: 'Rebar work',       hours: 8, overtimeHours: 0,   remarks: 'Beam cage fabrication' },
  { id: 'erp-015', employeeId: 'emp-009', employeeName: 'Dinesh Wickramasinghe', date: '2026-08-01', activityCode: 'EL-01', activityDescription: 'Electrical work', hours: 8, overtimeHours: 0, remarks: 'Main DB panel cable routing' },
  { id: 'erp-016', employeeId: 'emp-010', employeeName: 'Roshan Gunawardena', date: '2026-08-02', activityCode: 'GW-01', activityDescription: 'General labour',   hours: 8, overtimeHours: 0,   remarks: 'Scaffolding assistance' },
  { id: 'erp-017', employeeId: 'emp-011', employeeName: 'Tharanga Abeysekara',date: '2026-08-01', activityCode: 'PW-01', activityDescription: 'Plumbing work',    hours: 8, overtimeHours: 0,   remarks: 'Riser duct vertical stack' },
  { id: 'erp-018', employeeId: 'emp-013', employeeName: 'Sampath Ranasinghe', date: '2026-08-02', activityCode: 'MW-01', activityDescription: 'Masonry work',     hours: 8, overtimeHours: 1,   remarks: 'Plastering external facade' },
  { id: 'erp-019', employeeId: 'emp-014', employeeName: 'Udara Liyanage',     date: '2026-08-01', activityCode: 'GW-01', activityDescription: 'General labour',   hours: 8, overtimeHours: 0,   remarks: 'Safety railing installation support' },
  { id: 'erp-020', employeeId: 'emp-015', employeeName: 'Ajith Mendis',       date: '2026-08-02', activityCode: 'CW-02', activityDescription: 'Formwork',         hours: 8, overtimeHours: 0,   remarks: 'Slab soffit shuttering' },
];
