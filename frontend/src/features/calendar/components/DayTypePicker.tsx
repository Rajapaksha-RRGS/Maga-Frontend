...
const COLOR_MAP: Record<string, { dot: string; hoverBg: string; activeBg: string; activeText: string }> = {
  ...
  'normal':         { dot: 'bg-slate-400',   hoverBg: 'hover:bg-slate-50',   activeBg: 'bg-slate-100',   activeText: 'text-slate-800 font-semibold' },
  'dt-saturday':    { dot: 'bg-blue-500',    hoverBg: 'hover:bg-blue-50',    activeBg: 'bg-blue-50',     activeText: 'text-blue-700 font-semibold' },
  'saturday':       { dot: 'bg-blue-500',    hoverBg: 'hover:bg-blue-50',    activeBg: 'bg-blue-50',     activeText: 'text-blue-700 font-semibold' },
  ...
  'sunday':         { dot: 'bg-emerald-500', hoverBg: 'hover:bg-emerald-50', activeBg: 'bg-emerald-50', activeText: 'text-emerald-700 font-semibold' },
  'dt-shutdown':    { dot: 'bg-rose-500',    hoverBg: 'hover:bg-rose-50',    activeBg: 'bg-rose-50',     activeText: 'text-rose-700 font-semibold' },
  'shutdown':       { dot: 'bg-rose-500',    hoverBg: 'hover:bg-rose-50',    activeBg: 'bg-rose-50',     activeText: 'text-rose-700 font-semibold' },
  'dt-holiday':     { dot: 'bg-amber-500',   hoverBg: 'hover:bg-amber-50',   activeBg: 'bg-amber-50',    activeText: 'text-amber-700 font-semibold' },
  'public_holiday': { dot: 'bg-amber-500',   hoverBg: 'hover:bg-amber-50',   activeBg: 'bg-amber-50',    activeText: 'text-amber-700 font-semibold' },
    ...
    <div className="bg-white border border-slate-200 rounded-xl shadow-xl w-52 py-1.5 z-40 overflow-hidden animate-in fade-in zoom-in-95 duration-100">
      ...
      <div className="p-1 flex flex-col gap-0.5">
        {dayTypes.map((dt) => {
          ...
          const styling = COLOR_MAP[dt.id] || (dt.code && COLOR_MAP[dt.code]) || { dot: 'bg-blue-500', hoverBg: 'hover:bg-slate-50', activeBg: 'bg-blue-50', activeText: 'text-blue-700 font-semibold' };
